Custom: Packages that I've made myself or edited
  ...
  - Group Scene Loading is based on a Git-Amend YouTube video I've heavily edited for my systems. I'd advise against downloading it in this state. But if you do, you will need:
    - This Repository: https://github.com/starikcetin/Eflatun.SceneReference.git#4.1.1)
    - Odin Inspector: a paid tool, or you'll need to remove the Odin Inspector References by hand.
